//
//  XGChatAddFriendViewController.m
//  ChatProject
//
...
#import "XGChatAddFriendViewController.h"
#import "RCDataBaseManager.h"
#import "UIImageView+WebCache.h"
@interface XGChatAddFriendViewController ()

@end

@implementation XGChatAddFriendViewController
- (void)viewDidLoad {
    [super viewDidLoad];
...
- (void)setHeaderView {
    ...
    if ([self.targetUserInfo.portraitUri isEqualToString:@""]) {
        ...
        self.ivAva.image = [UIImage imageNamed:@"header"];
    } else {
        [self.ivAva sd_setImageWithURL:[NSURL URLWithString:self.targetUserInfo.portraitUri]
                      placeholderImage:[UIImage imageNamed:@"header"]];
    }
