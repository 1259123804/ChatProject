...
- (void)initialize {
  ...
  self.leftLabel.textColor = [self colorWithHexString:@"000000" alpha:1.0];
  self.leftLabel.translatesAutoresizingMaskIntoConstraints = NO;
  
  self.rightLabel = [[UILabel alloc] init];
  self.rightLabel.font = [UIFont systemFontOfSize:14.f];
    self.rightLabel.textColor = [self colorWithHexString:@"999999"
                                                   alpha:1.0];
  ...
  self.bottomLine = [[UIView alloc] init];
    self.bottomLine.backgroundColor = [self  colorWithHexString:@"dfdfdf"
                                                          alpha:1.0];
